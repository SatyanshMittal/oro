  ...
  return (
    <div className=' space-y-28 pb-28 text-white w-full'>
        ...
        <div className="h-full sm:w-[20%] my-auto ml-3 flex flex-col gap-4 ">
          ...
          <button className="border px-2 text-[14px] w-[70%] mt-1 py-[7px] rounded-full text-[#CFAF6C] border-[#CFAF6C] hover:bg-[#CFAF6C] hover:text-black hover:font-semibold transition-all duration-500  ">coming soon</button>
        </div>
