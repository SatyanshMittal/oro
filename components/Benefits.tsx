  ...
  return (
    <div className="min-h-screen space-y-28 pb-28 text-white w-full">
      ...
      <div className="flex items-center  justify-between">
        <div className="flex flex-col  gap-6 justify-center w-[15%]">
           <RoundLogo/> 
            <p className="text-3xl font-grotesk font-semibold"><span className="text-[#CFAF6C] ">ORO</span> in action</p>
            <p className="text-white font-jost opacity-60 leading-5">Invest, Track and Manage your assets in a simple, use-to-use web platform</p>
        </div>

        <Image width={1000} height={1000} src={video} alt="videoPreview" className=""/>
